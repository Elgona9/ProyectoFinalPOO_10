...
public class Moto extends MetodoTransporte {
	//ATRITUBOS NUEVOS
	...
	public Moto(double velocidadPromedio, double gastoGasolina, double capacidadTanque) {
    ...
    public double sugerirParadasGasolina(double distancia) {
    	double numParadasGasolina = Math.ceil(distancia / distanciaMaxima());
